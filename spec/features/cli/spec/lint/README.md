...
| [rule-rules](rule-rules/README.md) | Adds lint rules `R-001`–`R-011` for the Rule artifact kind — field shape, status and enforcement vocabularies, scope grammar, source resolution, the strict lesson↔rule promotion pair, supersession integrity, and rules-index sync. |
