...
**Archived 2026-06-03** — duplicate of (and superseded by) `deferred-ac-coverage-regex-truncates-hyphenated-ac-slugs`, which carries the richer root-cause analysis. That bug is now resolved by commit `ec1cbea`.
