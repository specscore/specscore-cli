...
- cli/spec/lint#ac:index-entries-ignores-nonidentity-cell-links — Added by a later canonical-index hardening increment; outside this plan's Fixed-files reporting scope.
- cli/spec/lint#ac:index-entries-fix-removes-duplicate-row — Added by a later canonical-index hardening increment; outside this plan's Fixed-files reporting scope.
