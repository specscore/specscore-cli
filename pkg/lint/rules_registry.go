...
var builtinRules = []Rule{
	...
	{ID: "status-mirror", Family: "frontmatter", Severity: "warning", Description: "Requires a status-bearing artifact's frontmatter status: to mirror its body **Status:** line."},
