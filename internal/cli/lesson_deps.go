...
type lessonCLIDeps struct {
	...
	addRelationTransaction func(string, string, string, string, lesson.RelationTransactionHooks) (bool, error)
	...
	inspectLegacy          func(string, []string, lesson.LegacyInventory, lesson.LegacyMapping) (lesson.LegacyApplyInspection, error)
...
func defaultLessonCLIDeps() lessonCLIDeps {
	return lessonCLIDeps{
		...
		addRelationTransaction: lesson.AddRelationTransaction,
		...
		inspectLegacy:          lesson.InspectLegacyApply,
